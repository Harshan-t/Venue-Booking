        ...
        <div>
            <div className='bg-[#F5F6FA] h-full min-h-screen'>
                ...
                <div className='flex justify-center items-center h-16 '>
                    ...
                    <div className='flex'>
                        <div className='bg-[#5b5e95] rounded-3xl w-8 h-8 text-xl flex justify-center text-white mr-2'>3</div>
                ...
                <div className='flex justify-center mb-8 mt-2'>
                    ...
                    <Link to="/conformation">
                        <button type="submit" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2.5 text-center">Confirm</button>
                    </Link>
                </div>
            </div>
        </div>
